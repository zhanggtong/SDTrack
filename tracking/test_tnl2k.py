...
def main(num, dataset, cfg, savename):
    ...
    parser.add_argument('--tracker_name', type=str, default='sdtrack', help='Name of tracking method.')
    parser.add_argument('--tracker_param', type=str, default=cfg, help='Name of config file.')
    parser.add_argument('--save_name', type=str, default='sdtrack_hivitb_v1-'+str(num), help='Name of save file.')
...
def set_state(state, tracker_param):
    path = './experiments/sdtrack/'+tracker_param+'.yaml'
...
if __name__ == '__main__':
    cfg = 'SDTrack-ep150-full-384'
    datasets = ['otb']  # 'otb''lasotext'
    for i in range(21, 31):
        #print(i)
        epoch = i# test the 150th epoch
