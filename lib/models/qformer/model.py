...
from lib.models.qformer.blocks import ImgBlock, TextBlock
from lib.models.qformer.masking import mask_top_right_quadrant
...
class QFormer(nn.Module):
    ...
    def forward(self, x: Tensor, img: Tensor, device) -> Tensor:
        """
        ...
        for text_block, img_block in zip(
            ...
            x = text_block(x) + x
            x = mask_top_right_quadrant(x, device)
