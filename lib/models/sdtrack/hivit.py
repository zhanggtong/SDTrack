...
from lib.models.sdtrack.base_backbone import BaseBackbone
from lib.models.sdtrack.cross_attension import CrossAttention
...
class BlockWithRPE(nn.Module):
    def __init__(self, input_size, dim, num_heads=0., mlp_ratio=4., qkv_bias=True, qk_scale=None, 
        ...
        self.crossattn = CrossAttention(dim=512)
    ...
    def forward(self, x, text=None, rpe_index=None, mask=None):
        cross_attn = None
        if text is None:
