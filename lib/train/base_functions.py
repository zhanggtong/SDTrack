...
from lib.train.dataset import TNL2k, TNL2k_Lang, Lasot_Lang, OTB_Lang, RefCOCOSeq
...
def names2datasets(name_list: list, settings, image_loader):
    ...
    for name in name_list:
        assert name in ["LASOT", "GOT10K_vottrain", "GOT10K_votval", "GOT10K_train_full", "GOT10K_official_val",
                        ...
                        "LASOT_Lang", "TNL2K", "TNL2K_Lang", "OTB_Lang", "RefCOCO14",
                        ]
        # Tracking Task
        if name == "TNL2K":
        ...
        if name == "RefCOCO14":
            datasets.append(RefCOCOSeq(settings.env.ref_coco_dir, refcoco_type="refcoco-unc", version="2014",
...
def get_optimizer_scheduler(net, cfg, settings):
    ...
    # Freeze Text Encoder
    if cfg.MODEL.TEXT_ENCODER in ['roberta-base', 'bert-base']:
        for n, p in net.named_parameters():
            if 'text_encoder' in n and p.requires_grad:
                p.requires_grad = False
                print("Freeze: ", n)

    # Vision-Language Tracking Task
    # print("Training Vision-Language Tracking Task: Freeze visual encoder...")
    # params = []
    # for n, p in net.named_parameters():
    ...
    # Vision-Language Tracking Task
    print("Training Vision-Language Tracking Task: Not freeze visual encoder...")
    param_dicts = [
