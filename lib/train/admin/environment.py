...
def create_default_local_file():
    ...
    default_settings = OrderedDict({
        ...
        'lasot_dir': empty_str,
        'tnl2k_dir': empty_str,
        'otb_lang_dir': empty_str,
        'ref_coco_dir': empty_str,
...
def create_default_local_file_ITP_train(workspace_dir, data_dir):
    ...
    default_settings = OrderedDict({
        ...
        'tnl2k_dir': os.path.join(data_dir, 'TNL_2K'),
        'otb_lang_dir': os.path.join(data_dir, 'OTB_sentences'),
        'ref_coco_dir': os.path.join(data_dir, 'refcoco'),
